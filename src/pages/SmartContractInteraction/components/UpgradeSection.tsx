...
export const UpgradeSection = ({ isLoggedIn }: { isLoggedIn: boolean }) => {
        ...
        <div className={styles.smartcontract}>
            <div className={styles.form}>
                ...
                <div className={styles.buttons}>
                    <button onClick={handleUpgrade} className={styles.button} disabled={!upgradeContractAddress}>Upgrade</button>
                </div>
                <textarea
                    rows={10}
                    className={styles.field}
